        ...
        <div class="container">
          ...
          <div class="description text-center">
            <div>
              ...
              I'm Tze How, a 30 year old Singaporean currently working as a Site Reliability Engineer in Citadel. <br /><br />
            ...
            <!-- <p> 
              I am currently on the lookout for career opportunities - contact me at tzeuse@gmail.com if you'd like to know more.
            </p> -->
          </div>
          <div class="profile">
              ...
              <div class="md-layout">
                <div v-for="column in columns" :key="column.icon" class="md-layout-item md-medium-size-33 md-small-size-100">
                  <div class="info" style="padding:0">
                    ...
                    <p v-for="topic in column.topics" :key="topic" style="color: #666666"> {{topic}}</p>
                  </div>
                </div>
        ...
        <div class="container" style="width:90%; max-width:none">
          <div class="md-layout">
            <div class="md-layout-item md-size-100 mx-auto">
              ...
              <div class="row">
                <div v-for="card in cards" :key="card.title" class="col s12 m6 l4" style="height:100%; position: relative; height: 300px; padding-top: 10px; padding-bottom: 10px;">
                  <div class="overlay">
